...
export function OtpVerifyScreen({ mobileNumber, onOtpVerified, onBackToMobile }) {
    ...
    const handleVerify = () => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            if (enteredOtp === "1234" || enteredOtp === "0000" || enteredOtp.length === 4) {
                if (onOtpVerified) {
                    onOtpVerified({
        ...
        <SafeAreaView style={styles.safeArea}>
            <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : undefined}>
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    <View style={styles.contentSpacing}>
                        <View style={styles.topBarRow}>
                            <TouchableOpacity onPress={onBackToMobile} activeOpacity={0.7} style={styles.backButtonContainer}>
                        ...
                        <View style={styles.titleContainer}>
                            ...
                            <Text style={styles.description}>
                                4-digit verification code sent to <Text style={styles.descriptionBold}>+91 {mobileNumber || "9876543210"}</Text>
                            </Text>
                        </View>
                        ...
                        <View style={styles.demoBanner}>
                            <View style={styles.demoBannerLeft}>
                                ...
                                <Text style={styles.demoBannerText}>Demo Test OTP: <Text style={styles.demoCodeText}>1234</Text></Text>
                            </View>
                            <TouchableOpacity onPress={() => setOtpValues(["1", "2", "3", "4"])} style={styles.autoFillButton} activeOpacity={0.7}>
                        ...
                        <View style={styles.card}>
                            <View style={styles.inputGroup}>
                                <Text style={styles.label}>Enter 4-Digit One Time Password</Text>
                            ...
                            <View style={styles.resendRow}>
                                ...
                                <TouchableOpacity onPress={handleResend} disabled={!canResend} style={styles.resendButtonContainer} activeOpacity={0.7}>
                                    <Text style={[styles.refreshIcon, canResend ? styles.refreshIconActive : styles.refreshIconDisabled]}>↻</Text>
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerText}>Session token will be issued for REST API security headers.</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    demoBanner: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#fef3c7", borderColor: "rgba(251, 191, 36, 0.4)", borderWidth: 1, borderRadius: 12, padding: 12 },
    demoBannerLeft: { flexDirection: "row", alignItems: "center", gap: 8 },
    sparkleIcon: { fontSize: 14 },
    demoBannerText: { fontSize: 12, color: "#1e293b" },
    demoCodeText: { fontWeight: "700", color: "#b45309", fontFamily: Platform.OS === "ios" ? "Courier" : "monospace", fontSize: 14 },
    autoFillButton: { backgroundColor: "#fde68a", borderColor: "#fcd34d", borderWidth: 1, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4 },
    autoFillButtonText: { fontSize: 11, fontWeight: "700", color: "#92400e" },
    card: { backgroundColor: "#ffffff", padding: 20, borderRadius: 16, borderColor: "#e2e8f0", borderWidth: 1, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2, gap: 24 },
    inputGroup: { gap: 12 },
    ...
    otpInput: { width: 48, height: 56, backgroundColor: "#f8fafc", borderColor: "#cbd5e1", borderWidth: 2, borderRadius: 12, textAlign: "center", fontSize: 20, fontWeight: "700", color: "#0f172a", fontFamily: Platform.OS === "ios" ? "Courier" : "monospace" },
    ...
    resendRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingTop: 4 },
